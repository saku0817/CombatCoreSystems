...
public final class CombatCoreSystems extends JavaPlugin {
    ...
    @Override public void onEnable() {
        ...
        registerListeners(List.of(regions, mobs, stats, damage, equipment, skills, encyclopedia, gui, mobAbilities, debug, triggers,
        ...
        combat.start(); mobs.start(); elements.start(); displays.start(); buffs.start(); spawns.start(); mobAbilities.start(); debug.start(); hud.start(); players.schedule(); backups.schedule(); web.start(); triggers.start();
